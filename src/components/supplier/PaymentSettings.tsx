...
import SupplierSubscriptionTab from './SupplierSubscriptionTab';
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Manage subscription and payment accounts</p>
      </div>
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Dentists can browse your products and place orders through the platform</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">You can send payment requests to dentists with your configured payment accounts</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Dentists can pay using FIB, ZainCash, or QI Card to your configured accounts</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">You receive payment notifications and can confirm payments in your dashboard</p>
                  </div>
                </div>
              </div>
            </CardContent>
