-- Fix critical database issues and function security (Fixed Version)
...
-- 2. Add missing subscription features if they don't exist (using DO block to avoid conflicts)
DO $$
BEGIN
  -- Basic plan features
